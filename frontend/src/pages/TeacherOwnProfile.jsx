    ...
    const fetchProfile = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:3000/api/teachers/${userId}`,
          {
              ...
              <form className="profile-form">
                ...
                <div className="form-group full-width">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={!isEditing}
                    placeholder="e.g. Certified English Tutor with 5 years experience"
                  />
                </div>
                ...
                <div
                  className="form-row highlight-box"
                  style={{
                    background: "#f0f9ff",
                    padding: "15px",
                    borderRadius: "8px",
            ...
            <div className="profile-section">
              <div className="section-header">
                ...
                <p style={{ fontSize: "0.9rem", color: "#666" }}>
                  Manage your teaching hours here (e.g. add "09:00" for 9 AM).
                </p>
                {isEditing && (
